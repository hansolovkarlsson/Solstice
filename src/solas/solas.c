...
static const OpcodeInfo OPCODE_TABLE[] = {
    ...
    {"INTTOSTR",   OP_INTTOSTR,   OPERAND_NONE},
    {"STRTOINT",   OP_STRTOINT,   OPERAND_NONE},
    {"FLOATTOSTR", OP_FLOATTOSTR, OPERAND_NONE},
    {"STRTOFLOAT", OP_STRTOFLOAT, OPERAND_NONE},
    {"RANDOM",     OP_RANDOM,     OPERAND_NONE},
    {"RANDOMIZE",  OP_RANDOMIZE,  OPERAND_NONE},
    {"STR_DELETE", OP_STR_DELETE, OPERAND_NONE},
    {"STR_INSERT", OP_STR_INSERT, OPERAND_NONE},
    ...
    {"TYPED_FILE_RESET",   OP_TYPED_FILE_RESET,   OPERAND_IMMEDIATE}, // operand = packed record_byte_size * MAX_SYMBOLS + file sym idx
    ...
    {"READ_TYPED_FILE_BYTE",  OP_READ_TYPED_FILE_BYTE,  OPERAND_VAR},
    {"WRITE_TYPED_FILE_BYTE", OP_WRITE_TYPED_FILE_BYTE, OPERAND_VAR},
    {"READ_TYPED_FILE_SHORTINT",  OP_READ_TYPED_FILE_SHORTINT,  OPERAND_VAR},
    {"WRITE_TYPED_FILE_SHORTINT", OP_WRITE_TYPED_FILE_SHORTINT, OPERAND_VAR},
    {"READ_TYPED_FILE_WORD",  OP_READ_TYPED_FILE_WORD,  OPERAND_VAR},
    {"WRITE_TYPED_FILE_WORD", OP_WRITE_TYPED_FILE_WORD, OPERAND_VAR},
    ...
    {"SETLENGTH",         OP_SETLENGTH,         OPERAND_NONE},
    {"LOAD_DYNARR_LEN",   OP_LOAD_DYNARR_LEN,   OPERAND_NONE},
    {"LOAD_DYNARR_IDX",   OP_LOAD_DYNARR_IDX,   OPERAND_NONE},
    {"STORE_DYNARR_IDX",      OP_STORE_DYNARR_IDX,      OPERAND_NONE},
    {"STORE_DYNARR_IDX_CHAR", OP_STORE_DYNARR_IDX_CHAR, OPERAND_NONE},
    {"COPY_DYNARR",       OP_COPY_DYNARR,       OPERAND_NONE},
};
